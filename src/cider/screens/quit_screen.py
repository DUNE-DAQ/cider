...
class QuitScreen(Screen):
    ...
    def compose(self):
        yield Grid(
            ...
            Button("Quit and Save", variant="success", id="quit_screen_savequit_button", classes="pop_up_button quit_screen_button"),
            Button("Quit Without Saving", variant="warning", id="quit_screen_quit_button", classes="pop_up_button quit_screen_button"),
            Button("Cancel", variant="error", id="quit_screen_cancel_button", classes="pop_up_button quit_screen_button"),
            id="quit_dialog",
